...
O **SAF-T Portugal** atualmente é um third-party e está focado em consultas e importação do xml de faturas que são gerados a partir de outro aplicativos. O SAF-T Portugal, atualmente, vai iniciar o processo o processo de homologação do sistema de emissão de faturas brevemente.
