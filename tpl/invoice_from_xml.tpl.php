...
$hashBadgeMap = [
    ...
    'hash_chain_prev_missing' => ['color' => '#856404', 'bg' => '#fff3cd', 'border' => '#ffc107', 'icon' => '⚠', 'label' => 'Cadeia hash inválida'],
    'hash_chain_order_invalid'=> ['color' => '#721c24', 'bg' => '#f8d7da', 'border' => '#f5c6cb', 'icon' => '✗', 'label' => 'Ordem de série inválida'],
    'hash_chain_gap_suspect'  => ['color' => '#856404', 'bg' => '#fff3cd', 'border' => '#ffc107', 'icon' => '⚠', 'label' => 'Sequência inválida'],
